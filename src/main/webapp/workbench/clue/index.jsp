    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#create-clue").click(function () {
                $.ajax({
                    url: "<%=basePath%>clue/query-allUser.do",
                    type: "get",
                    dataType: "json",
            ...
            $("#add-clue").click(function () {
                /**
                 * 前端需要先验证用户的输入是否符合要求  此处略
                 */
                $.ajax({
                    url: "<%=basePath%>clue/save-clue.do",
                    data:{
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="add-clue">保存</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" class="btn btn-primary" id="create-clue"><span
        ...
        <div style="position: relative;top: 50px;">
            <table class="table table-hover">
                ...
                <tr>
                    <td><input type="checkbox"/></td>
                    <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='clue/detail.do?id=a0053fbf4f6645e8a9963d14011d7757';">李薰莉女士</a>
                    </td>
                    <td>华科科技</td>
                    <td>873-123456</td>
                    <td>15987387638</td>
                ...
                <tr class="active">
                    <td><input type="checkbox"/></td>
                    <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='clue/detail.do?id=61ba3630a3ee4b289cff7c03601f18f7';">Jeck-Chen教授</a>
                    </td>
                    <td>Apache</td>
                    <td>010-84846003</td>
                    <td>18839247583</td>
