...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //打开关联市场活动模态窗口
            $("#showBindModal").click(function () {
                $("#bindModal").modal("show")
                //$("#search-activity").focus() //无效 不晓得怎嘛回事儿
            })
            ...
            $("#show-activityM").on("click",$("input[name=xz]"),function () {
                ...
                if(e.keyCode == 13){
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#show-activityM").html(html)
                        }
                    })
                    return false; //禁用事件上传 写在if(e.keyCode == 13){}中 否则造成文本框无法输入文本
                }
            })
            ...
            $("#bindAct").click(function () {
                ...
                for(var i = 0; i < $xz.length; i++){
                    param += "&actId=" + $($xz[i]).val()
                }
                $.ajax({
                    url: "clue/save-bindAct.do",
                    data: param,
                    type: "get",
                    dataType: "json",
                    success: function (data) {
        ...
        function activityList(){
            $.ajax({
                url: "clue/query-clueActivity.do",
                data: {
                    "id": "${clue.id}"
                },
                type: "get",
                ...
                success : function (data) {
                    ...
                    var html="";
                    $.each(data,function(i,n){
                        html += '<tr id="'+ n.id +'"><td>'+n.name+'</td>' +
                            '<td>'+n.startDate+'</td>' +
                            '<td>'+n.endDate+'</td>' +
                            '<td>'+n.owner+'</td>' +
                            '<td><a href="javascript:void(0);" onclick=delActivityRelation("'+n.id+'") style="text-decoration: none;">' +
        ...
        function delActivityRelation(id) {
            if(confirm("请确认是否解除关联")){
                $.ajax({
                    url: "clue/del-clueActivity.do",
                    data: {
                        "id": id
                    },
                    type: "get",
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
                    ...
                    <tbody id="show-activityM"></tbody>
                </table>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="bindAct">关联</button>
            </div>
        </div>
    </div>
</div>
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:void(0);" id="showBindModal" style="text-decoration: none;">
